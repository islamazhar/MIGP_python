...
preds= {}
test_cases = set()
file_r1 = open('../models/pass2path_1667500_migp_attack_dasr.txt.predictions','r')
file_r2 = open('../test_files/migp_attack_dasr10_g.txt')
import pdb
...
print("Das-R n = 10 or m = 10")
for pred_c in [10, 100, 1000]:
    count = 0
    total = 0
    for test_line in open('../test_files/migp_attack_dasr10_g.txt'):
